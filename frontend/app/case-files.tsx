    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          <Text style={styles.headerText}>Case Files</Text>
        </View>

        <View style={styles.infoBox}>
          <Text style={styles.infoText}>
            <Text style={styles.infoHeading}>Case 1{'\n'}</Text>
            Read about cases and their outcomes
          </Text>
        </View>
        <View style={styles.infoBox}>
          <Text style={styles.infoText}>
            <Text style={styles.infoHeading}>Case 2{'\n'}</Text>
            Read about cases and their outcomes
        ...
        <View style={styles.infoBox}>
          <Text style={styles.infoText}>
            <Text style={styles.infoHeading}>Case 3{'\n'}</Text>
            Read about cases and their outcomes
          </Text>
        </View>
        </ScrollView>
